...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{98, 105, 109, 1821933, 4745537, 4849249, 5144726, 5393365, 5442204, 5594513, 5741474, 5991895, 57476627, 76061764, 87367608, 142301684, 209784577, 288167040, 328878574, 359333139, 364006368, 393324759, 407283053, 437335495, 446171152, 452737314, 480756972, 493819893, 501039929, 520590566, 610723709, 640252688, 724060212, 784433846, 798803052, 922671056, 946786476, 995006396, 1058459579, 1058556349, 1067353468, 1071652316, 1103412149, 1126235833, 1139639992, 1181037546, 1204816148, 1214453688, 1224901875, 1228056441, 1238832007, 1247875546, 1257939113, 1280549057, 1280845662, 1282943179, 1313416818, 1352786672, 1371405953, 1381630732, 1395555037, 1398464674, 1431819701, 1436822557, 1441685007, 1532710347, 1537812987, 1620824029, 1621420777, 1623148745, 1639293562, 1705629508, 1723805383, 1763375486, 1768617329, 1836975402, 1873474154, 1886001471, 1915412854, 1916009602, 1920782701, 1981972957, 1988514268, 2010580328, 2022294396, 2025055113, 2048392659, 2054707467, 2082663554, 2127021138};
		
		protected static string[] fields = new string[]{"b", "i", "m", "isGlobal", "__a", "arr", "get", "len", "map", "pop", "set", "xml", "getEnumConstructs", "remove", "filter", "resize", "output", "stream", "iterator", "lastIndexOf", "attributeMap", "attributes", "hasNext", "message", "positionAtLine", "reverse", "nOccupied", "getBytes", "insert", "length", "writeFullBytes", "writeString", "replace", "pretty", "firstElement", "cachedIndex", "toString", "hashes", "addChild", "_eof", "splice", "exists", "copy", "hasChildren", "removeChild", "join", "concat", "close", "next", "enumConstructor", "writeByte", "push", "position", "size", "sort", "quicksort", "vals", "spliceVoid", "writeNode", "writeBytes", "cachedKey", "getEnumName", "createEnumIndex", "createEnum", "nodeValue", "concatNative", "nBuckets", "__unsafe_get", "__unsafe_set", "indexOf", "lookup", "toDynamic", "regex", "readByte", "allEnums", "parent", "readLine", "children", "__get", "__set", "nodeName", "lineNumber", "nodeType", "readUntil", "upperBound", "unshift", "_keys", "enumParameters", "shift", "slice"};
